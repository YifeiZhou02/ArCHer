...
The spare room part 1 is some text that varies. The spare room part 1 is " box.[if c_0 is open and there is something in the c_0] The box contains [a list of things in the c_0]. Huh, weird.[end if]".
...
The spare room part 3 is some text that varies. The spare room part 3 is " Hey, want to see a trunk? Look over there, a trunk.[if c_1 is open and there is something in the c_1] The trunk contains [a list of things in the c_1].[end if]".
...
The spare room part 5 is some text that varies. The spare room part 5 is " You can make out a cabinet. Now that's what I call TextWorld![if c_2 is open and there is something in the c_2] The cabinet contains [a list of things in the c_2]. There's something strange about this being here, but you can't put your finger on it.[end if]".
The spare room part 6 is some text that varies. The spare room part 6 is "[if c_2 is open and the c_2 contains nothing] The cabinet is empty! What a waste of a day![end if]".
...
The description of o_0 is "The pair of pants is brand new.".
...
Test quest0_0 with "open box / take pair of pants from box / drop pair of pants"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is your task for today. First off, ensure that the box is open. And then, recover the pair o".
The objective part 1 is some text that varies. The objective part 1 is "f pants from the box in the spare room. After stealing the pair of pants, deposit the pair of pants on the floor of the spare room. And once you've done that, you win!".
