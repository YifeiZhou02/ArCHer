...
The garage part 1 is some text that varies. The garage part 1 is "[if c_0 is open and the c_0 contains nothing] The crate is empty! This is the worst thing that could possibly happen, ever![end if]".
...
The sauna part 1 is some text that varies. The sauna part 1 is " cabinet.[if c_1 is open and there is something in the c_1] The cabinet contains [a list of things in the c_1]. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
Test quest0_0 with "go east / take shadfly from crate / drop shadfly"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. Your first objective is to travel east. And then, take the shadfly from the crate inside the garage. The".
The objective part 1 is some text that varies. The objective part 1 is "n, deposit the shadfly on the floor of the garage. Once that's all handled, you can stop!".
