...
The workshop part 2 is some text that varies. The workshop part 2 is " You make out a coffer.[if c_1 is open and there is something in the c_1] The coffer contains [a list of things in the c_1].[end if]".
The workshop part 3 is some text that varies. The workshop part 3 is "[if c_1 is open and the c_1 contains nothing] The coffer is empty! This is the worst thing that could possibly happen, ever![end if]".
...
Test quest0_0 with "open coffer / take Quote of the Day Calendar from coffer / insert Quote of the Day Calendar into box"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First step, make it so that the coffer inside the workshop is open. After that, recover the Quote of the".
The objective part 1 is some text that varies. The objective part 1 is " Day Calendar from the coffer in the workshop. Having picked up the Quote of the Day Calendar, you can deposit the Quote of the Day Calendar inside the box. And once you've done that, you win!".
