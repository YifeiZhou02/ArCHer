...
The c_0 is in r_0.
The c_0 is closed.
The description of f_1 is "The garlic clove looks appetizing.".
...
Test quest0_0 with "open locker / take pear from locker / eat pear"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First thing I need you to do is to ensure that the locker is open. And then, take the pear from the lock".
The objective part 1 is some text that varies. The objective part 1 is "er. After that, eat the pear. And if you do that, you're the winner!".
