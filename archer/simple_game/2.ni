...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "You are in a bedchamber. A normal one.
 ...
 Hey, want to see a chest? Look over there, a chest![if c_0 is open and there is something in the c_0] The chest contains [a list of things in the c_0], so there's that.[end if]".
...
The bedchamber part 3 is some text that varies. The bedchamber part 3 is " basket in the corner.[if c_1 is open and there is something in the c_1] The basket contains [a list of things in the c_1].[end if]".
The bedchamber part 4 is some text that varies. The bedchamber part 4 is "[if c_1 is open and the c_1 contains nothing] The basket is empty! What a waste of a day![end if]".
...
Test quest0_0 with "open basket / take key from basket / unlock chest with key"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another profound game of TextWorld! First thing I need you to do is to open the basket in the bedchamber. And then, pick up the key from the basket. And then, doublecheck that the chest is ".
The objective part 1 is some text that varies. The objective part 1 is "unlocked. And if you do that, you're the winner!".
