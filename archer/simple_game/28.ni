...
The bedroom part 1 is some text that varies. The bedroom part 1 is " locker is in the corner.[if c_0 is open and there is something in the c_0] The locker contains [a list of things in the c_0]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
Test quest0_0 with "go east / unlock locker with keycard / open locker"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First, it would be fantastic if you could venture east. And then, look and see that the locker is unlock".
The objective part 1 is some text that varies. The objective part 1 is "ed. And then, ensure that the locker inside the bedroom is open. Got that? Good!".
