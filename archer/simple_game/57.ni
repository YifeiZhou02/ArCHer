...
The cubicle part 2 is some text that varies. The cubicle part 2 is "[if c_0 is open and the c_0 contains nothing] The box is empty, what a horrible day![end if]".
...
The playroom part 0 is some text that varies. The playroom part 0 is "You find yourself in a playroom. A normal kind of place. You start to take note of what's in the room.
...
The description of o_0 is "The stapler is modern.".
...
Test quest0_0 with "unlock box with latchkey / open box / take stapler from box"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is how to play! First step, unlock the box in the cubicle. After unlocking the box, ensure that the box is open. After pulling open the box, recover the stapler from the box".
The objective part 1 is some text that varies. The objective part 1 is " within the cubicle. And if you do that, you're the winner!".
