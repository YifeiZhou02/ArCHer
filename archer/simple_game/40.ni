...
The spare room part 0 is some text that varies. The spare room part 0 is "This is going to sound unbelievable, but you've just entered a spare room.
 ...
 You see a gleam over in a corner, where you can see a coffer. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[if c_0 is open and there is something in the c_0] The coffer contains [a list of things in the c_0].[end if]".
...
The spare room part 2 is some text that varies. The spare room part 2 is " You can see a table. [if there is something on the s_0]On the table you can see [a list of things on the s_0].[end if]".
The spare room part 3 is some text that varies. The spare room part 3 is "[if there is nothing on the s_0]But the thing is empty, unfortunately.[end if]".
...
The s_0 is in r_0.
The description of o_0 is "The frisbee is well-used.".
...
Test quest0_0 with "open coffer / take frisbee from coffer / put frisbee on table"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is your task for today. First stop, open the coffer. After that, take the frisbee from the coffer. And then, put the frisbee on the table. Tha".
The objective part 1 is some text that varies. The objective part 1 is "t's it!".
