...
Test quest0_0 with "open cabinet / take ladle from cabinet / drop ladle"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is how to play! First stop, open the cabinet within the canteen. Then, retrieve the ladle fr".
The objective part 1 is some text that varies. The objective part 1 is "om the cabinet within the canteen. Then, throw the ladle on the floor of the canteen. Once that's all handled, you can stop!".
