...
The studio part 0 is some text that varies. The studio part 0 is "You find yourself in a studio.
 ...
 You bend down to tie your shoe. When you stand up, you notice a Canadian limited edition safe. Is this it? Is this what you came to TextWorld to see? a Canadian limited edition safe?[if c_0 is open and there is something in the c_0] The Canadian limited edition safe contains [a list of things in the c_0].[end if]".
The studio part 1 is some text that varies. The studio part 1 is "[if c_0 is open and the c_0 contains nothing] The Canadian limited edition safe is empty! What a waste of a day![end if]".
The studio part 2 is some text that varies. The studio part 2 is " You can see a display.[if c_1 is open and there is something in the c_1] The display contains [a list of things in the c_1].[end if]".
The studio part 3 is some text that varies. The studio part 3 is "[if c_1 is open and the c_1 contains nothing] The display is empty, what a horrible day![end if]".
...
The description of c_0 is "The Canadian limited edition safe looks strong, and impossible to break. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The description of o_0 is "The soap dispenser is clean.".
...
Test quest0_0 with "open display / take Canadian limited edition passkey from display / lock Canadian limited edition safe with Canadian limited edition passkey"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is how to play! First thing I need you to do is to open the display within the studio. After that, pick up the Canadian limited edition passkey from the display. Then, lock ".
The objective part 1 is some text that varies. The objective part 1 is "the Canadian limited edition safe. That's it!".
