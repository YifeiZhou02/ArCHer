...
The kitchen part 1 is some text that varies. The kitchen part 1 is " cuboid safe nearby.[if c_0 is open and there is something in the c_0] The cuboid safe contains [a list of things in the c_0].[end if]".
...
Test quest0_0 with "unlock cuboid safe with cuboid latchkey / open cuboid safe / insert book into cuboid safe"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an life changing round of TextWorld? You do! First thing I need you to do is to insert the cuboid latchkey into the cuboid safe's lock to unloc".
The objective part 1 is some text that varies. The objective part 1 is "k it. And then, make sure that the cuboid safe inside the kitchen is opened. After you have opened the cuboid safe, you can deposit the book inside the cuboid safe. Alright, thanks!".
