...
The cookery part 0 is some text that varies. The cookery part 0 is "You have walked into the most standard of all possible cookerys. Okay, just remember what you're here to do, and everything will go great.
...
The cookery part 2 is some text that varies. The cookery part 2 is " You scan the room for a case, and you find a case. A case... Is that really what you were looking for?[if c_1 is open and there is something in the c_1] The case contains [a list of things in the c_1]. Huh, weird.[end if]".
...
The cookery part 4 is some text that varies. The cookery part 4 is " You can see a pan. The pan is ordinary.[if there is something on the s_0] On the pan you can see [a list of things on the s_0].[end if]".
The cookery part 5 is some text that varies. The cookery part 5 is "[if there is nothing on the s_0] But the thing is empty, unfortunately.[end if]".
...
The cellar part 0 is some text that varies. The cellar part 0 is "Okay, so you're in a cellar, cool, but is it normal? You better believe it is. Okay, just remember what you're here to do, and everything will go great.
...
Test quest0_0 with "take latchkey from case / unlock box with latchkey / open box"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is your task for today. Your first objective is to recover the latchkey from the case. Then, doublecheck that the box is unlocked. And then, e".
The objective part 1 is some text that varies. The objective part 1 is "nsure that the box inside the cookery is open. And once you've done that, you win!".
