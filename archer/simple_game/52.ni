...
The pantry part 0 is some text that varies. The pantry part 0 is "Look at that sign! What does it say? It says Welcome to the pantry? Well that's cool.
 ...
 You can see a shelf. [if there is something on the s_0]You see [a list of things on the s_0] on the shelf. There's something strange about this being here, but you can't put your finger on it.[end if]".
The pantry part 1 is some text that varies. The pantry part 1 is "[if there is nothing on the s_0]The shelf appears to be empty. You make a mental note to not get your hopes up the next time you see a shelf in a room.[end if]".
...
Test quest0_0 with "go south / go east / take whisk"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a fast paced episode of TextWorld! Here is how to play! First step, make an attempt to venture south. Then, try to travel east. Once you finish that, pick up the whisk from the flo".
The objective part 1 is some text that varies. The objective part 1 is "or of the cookhouse. That's it!".
