...
The workshop part 0 is some text that varies. The workshop part 0 is "You've just walked into a workshop. Let's see what's in here.
 ...
 You can see a portmanteau. Now that's what I call TextWorld![if c_0 is open and there is something in the c_0] The portmanteau contains [a list of things in the c_0]. Wow, isn't TextWorld just the best?[end if]".
The workshop part 1 is some text that varies. The workshop part 1 is "[if c_0 is open and the c_0 contains nothing] The portmanteau is empty! This is the worst thing that could possibly happen, ever![end if]".
The workshop part 2 is some text that varies. The workshop part 2 is " You can see a mantelpiece. The mantelpiece is usual.[if there is something on the s_0] On the mantelpiece you make out [a list of things on the s_0]. You can't wait to tell the folks at home about this![end if]".
...
The s_0 is in r_2.
The description of o_0 is "The keyboard seems well matched to everything else here".
...
Test quest0_0 with "go north / go east / take keyboard from portmanteau"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a fast paced game of TextWorld! Here is how to play! Your first objective is to try to go north. After that, make an attempt to head east. And then, retrieve the keyboard from the ".
The objective part 1 is some text that varies. The objective part 1 is "portmanteau in the workshop. Got that? Good!".
