...
The spare room part 0 is some text that varies. The spare room part 0 is "You find yourself in a spare room. A typical one. You can barely contain your excitement.

 You can see a table. [if there is something on the s_0]On the table you see [a list of things on the s_0].[end if]".
The spare room part 1 is some text that varies. The spare room part 1 is "[if there is nothing on the s_0]But the thing hasn't got anything on it. It would have been so cool if there was stuff on the table.[end if]".
...
The bar part 0 is some text that varies. The bar part 0 is "You are in a bar. An usual one. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
Test quest0_0 with "take fondue from table / go east / eat fondue"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First thing I need you to do is to take the fondue from the table within the spare room. Then, eat the f".
The objective part 1 is some text that varies. The objective part 1 is "ondue. And if you do that, you're the winner!".
