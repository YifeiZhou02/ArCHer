...
The spare room part 1 is some text that varies. The spare room part 1 is " chest, which looks usual, right there by you.[if c_0 is open and there is something in the c_0] The chest contains [a list of things in the c_0].[end if]".
The spare room part 2 is some text that varies. The spare room part 2 is "[if c_0 is open and the c_0 contains nothing] The chest is empty! This is the worst thing that could possibly happen, ever![end if]".
...
The basement part 0 is some text that varies. The basement part 0 is "Here we are in the basement.
...
Test quest0_0 with "go east / take durian from chest / eat durian"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First thing I need you to do is to try to travel east. And then, recover the durian from the chest. Afte".
The objective part 1 is some text that varies. The objective part 1 is "r that, eat the durian. That's it!".
