...
The bedroom part 1 is some text that varies. The bedroom part 1 is "[if there is nothing on the s_0]But there isn't a thing on it. It would have been so cool if there was stuff on the stand.[end if]".
...
Test quest0_0 with "go south / go east / take controller"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is how to play! Your first objective is to make an effort to venture south. Then, travel east. And then, pick up the controller from the floor of the playroom. And once you'".
