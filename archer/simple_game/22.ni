...
The pantry part 0 is some text that varies. The pantry part 0 is "You've just shown up in a pantry. Let's see what's in here.
...
The closet part 0 is some text that varies. The closet part 0 is "Of every closet you could have walked into, you had to walk into an ordinary one. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. Your first objective is to go east. With that accomplished, pick up the sandwich from the floor of the p".
The objective part 1 is some text that varies. The objective part 1 is "antry. After that, eat the sandwich. And once you've done that, you win!".
