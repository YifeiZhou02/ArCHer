...
The laundromat part 1 is some text that varies. The laundromat part 1 is " safe, which looks ordinary, in the room.[if c_0 is open and there is something in the c_0] The safe contains [a list of things in the c_0].[end if]".
...
Test quest0_0 with "go east / unlock safe with key / open safe"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First thing I need you to do is to make an effort to go east. After that, look and see that the safe is ".
The objective part 1 is some text that varies. The objective part 1 is "unlocked. Then, ensure that the safe inside the laundromat is open. Got that? Good!".
