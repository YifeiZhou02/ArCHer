...
The kitchenette part 2 is some text that varies. The kitchenette part 2 is "[if c_0 is open and the c_0 contains nothing] The freezer is empty! What a waste of a day![end if]".
The kitchenette part 3 is some text that varies. The kitchenette part 3 is " You see a gleam over in a corner, where you can see a pan. [if there is something on the s_0]You see [a list of things on the s_0] on the pan.[end if]".
...
Test quest0_0 with "open freezer / take spork from freezer / put spork on pan"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another exciting round of TextWorld! Here is your task for today. First of all, ensure that the freezer within the kitchenette is open. Then, recover the spork from the freezer. Then, put t".
The objective part 1 is some text that varies. The objective part 1 is "he spork on the pan. Got that? Good!".
