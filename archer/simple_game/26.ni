...
The attic part 0 is some text that varies. The attic part 0 is "You arrive in an attic. An usual kind of place. Okay, just remember what you're here to do, and everything will go great.
 ...
 You make out a American box.[if c_0 is open and there is something in the c_0] The American box contains [a list of things in the c_0]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
...
The attic part 2 is some text that varies. The attic part 2 is " [if c_1 is locked]A locked[else if c_1 is open]An open[otherwise]A closed[end if]".
The attic part 3 is some text that varies. The attic part 3 is " trunk is nearby.[if c_1 is open and there is something in the c_1] The trunk contains [a list of things in the c_1].[end if]".
The attic part 4 is some text that varies. The attic part 4 is "[if c_1 is open and the c_1 contains nothing] The trunk is empty, what a horrible day![end if]".
...
The canteen part 1 is some text that varies. The canteen part 1 is " fridge here.[if c_2 is open and there is something in the c_2] The fridge contains [a list of things in the c_2].[end if]".
...
The c_2 is in r_0.
The c_2 is open.
The description of k_0 is "The American passkey is heavier than it looks.".
...
Test quest0_0 with "go north / go east / open American box"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. Your first objective is to attempt to go north. Then, take a trip east. And then, make absolutely sure t".
The objective part 1 is some text that varies. The objective part 1 is "hat the American box is ajar. Once that's all handled, you can stop!".
