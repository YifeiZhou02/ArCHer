...
The studio part 0 is some text that varies. The studio part 0 is "I just think it's awesome that you're in a studio now. You begin to take stock of what's in the room.

 You can see [if c_0 is locked]a locked[else if c_0 is open]an opened[otherwise]a closed[end if]".
The studio part 1 is some text that varies. The studio part 1 is " chest nearby.[if c_0 is open and there is something in the c_0] The chest contains [a list of things in the c_0].[end if]".
The studio part 2 is some text that varies. The studio part 2 is "[if c_0 is open and the c_0 contains nothing] What a letdown! The chest is empty![end if]".
...
Test quest0_0 with "unlock chest with latchkey / open chest / take Comic Strip Calendar from chest"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! First step, look and see that the chest in the studio is unlocked. Then, make absolutely sure that the chest within the studio is opened. After you".
The objective part 1 is some text that varies. The objective part 1 is " have opened the chest, recover the Comic Strip Calendar from the chest within the studio. And once you've done that, you win!".
