...
The garage part 1 is some text that varies. The garage part 1 is " toolbox is right there by you.[if c_0 is open and there is something in the c_0] The toolbox contains [a list of things in the c_0].[end if]".
The garage part 2 is some text that varies. The garage part 2 is "[if c_0 is open and the c_0 contains nothing] The toolbox is empty! What a waste of a day![end if]".
...
The shower part 0 is some text that varies. The shower part 0 is "You've just sauntered into a shower.
 ...
 You scan the room for a basket, and you find a basket.[if c_1 is open and there is something in the c_1] The basket contains [a list of things in the c_1].[end if]".
The shower part 1 is some text that varies. The shower part 1 is "[if c_1 is open and the c_1 contains nothing] The basket is empty! What a waste of a day![end if]".
...
Test quest0_0 with "go east / take insect from toolbox / drop insect"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. Your first objective is to go east. And then, take the insect from the toolbox in the garage. And then, ".
The objective part 1 is some text that varies. The objective part 1 is "deposit the insect on the floor of the garage. And if you do that, you're the winner!".
