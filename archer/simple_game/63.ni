...
The bedroom part 1 is some text that varies. The bedroom part 1 is " locker here.[if c_0 is open and there is something in the c_0] The locker contains [a list of things in the c_0].[end if]".
The bedroom part 2 is some text that varies. The bedroom part 2 is "[if c_0 is open and the c_0 contains nothing] The locker is empty! This is the worst thing that could possibly happen, ever![end if]".
...
Test quest0_0 with "unlock locker with latchkey / open locker / insert soap dispenser into locker"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an life changing round of TextWorld? You do! Here is your task for today. First of all, you could, like, insert the latchkey into the locker's ".
The objective part 1 is some text that varies. The objective part 1 is "lock to unlock it. Once you have unlocked the locker, open the locker. And then, you can put the soap dispenser into the locker. That's it!".
