...
The canteen part 0 is some text that varies. The canteen part 0 is "If you're wondering why everything seems so ordinary all of a sudden, it's because you've just walked into the canteen.

 You make out [if c_0 is locked]a locked[else if c_0 is open]an opened[otherwise]a closed[end if]".
The canteen part 1 is some text that varies. The canteen part 1 is " safe.[if c_0 is open and there is something in the c_0] The safe contains [a list of things in the c_0].[end if]".
...
The canteen part 3 is some text that varies. The canteen part 3 is " Look over there! a fresh laundry scented safe.[if c_1 is open and there is something in the c_1] The fresh laundry scented safe contains [a list of things in the c_1].[end if]".
The canteen part 4 is some text that varies. The canteen part 4 is "[if c_1 is open and the c_1 contains nothing] The fresh laundry scented safe is empty! This is the worst thing that could possibly happen, ever![end if]".
...
The c_0 is in r_0.
The c_0 is open.
The description of c_1 is "The fresh laundry scented safe looks strong, and impossible to crack. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The description of k_1 is "The fresh laundry scented passkey looks useful".
...
Test quest0_0 with "take keycard from safe"
...
Test quest1_0 with "take keycard from safe / close safe / lock safe with keycard"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! First off, pick up the keycard from the safe inside the canteen. And then, make absolutely sure that the safe within the canteen is closed. And then, lock the safe. That's it!".
