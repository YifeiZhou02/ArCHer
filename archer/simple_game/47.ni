...
The study part 1 is some text that varies. The study part 1 is " cake scented chest.[if c_0 is open and there is something in the c_0] The cake scented chest contains [a list of things in the c_0].[end if]".
The study part 2 is some text that varies. The study part 2 is "[if c_0 is open and the c_0 contains nothing] The cake scented chest is empty! This is the worst thing that could possibly happen, ever![end if]".
...
The cubicle part 1 is some text that varies. The cubicle part 1 is "[if c_1 is open and the c_1 contains nothing] The suitcase is empty, what a horrible day![end if]".
...
The description of c_0 is "The cake scented chest looks strong, and impossible to destroy. [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
The c_1 is in r_0.
The c_1 is closed.
The description of k_0 is "The metal of the cake scented passkey is brushed.".
...
The description of f_1 is "The coconut looks tantalizing.".
...
Test quest0_0 with "open cake scented chest / take sandwich from cake scented chest / eat sandwich"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an profound round of TextWorld? You do! Here is your task for today. First step, open the cake scented chest inside the study. After that, retr".
The objective part 1 is some text that varies. The objective part 1 is "ieve the sandwich from the cake scented chest inside the study. After that, eat the sandwich. Once that's all handled, you can stop!".
