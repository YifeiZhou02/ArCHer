...
The canteen part 0 is some text that varies. The canteen part 0 is "You've just shown up in a canteen.
 ...
 You bend down to tie your shoe. When you stand up, you notice a refrigerator.[if c_0 is open and there is something in the c_0] The refrigerator contains [a list of things in the c_0].[end if]".
...
The studio part 0 is some text that varies. The studio part 0 is "You find yourself in a studio. A standard kind of place. You begin to take stock of what's in the room.
 ...
 You make out a mantle. The mantle is normal.[if there is something on the s_0] On the mantle you make out [a list of things on the s_0].[end if]".
The studio part 1 is some text that varies. The studio part 1 is "[if there is nothing on the s_0] However, the mantle, like an empty mantle, has nothing on it.[end if]".
...
Test quest0_0 with "go east / take sandwich / eat sandwich"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! First off, make an attempt to move east. Then, pick-up the sandwich from the floor of the cookery. And then, eat".
The objective part 1 is some text that varies. The objective part 1 is " the sandwich. Got that? Good!".
