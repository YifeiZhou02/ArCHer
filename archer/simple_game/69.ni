...
The office part 0 is some text that varies. The office part 0 is "You have stumbled into an office. Not the office you'd expect. No, this is an office.
...
Test quest0_0 with "open box / take cookie from box / eat cookie"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is how to play! Your first objective is to ensure that the box is open. After that, retrieve the cookie from the box inside the office. And then, eat the cookie. That's it!".
