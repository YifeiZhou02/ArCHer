...
The bathroom part 1 is some text that varies. The bathroom part 1 is " type T box, which looks normal, close by.[if c_0 is open and there is something in the c_0] The type T box contains [a list of things in the c_0]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
The bathroom part 2 is some text that varies. The bathroom part 2 is "[if c_0 is open and the c_0 contains nothing] The type T box is empty, what a horrible day![end if]".
...
The chamber part 1 is some text that varies. The chamber part 1 is " safe nearby.[if c_1 is open and there is something in the c_1] The safe contains [a list of things in the c_1].[end if]".
The chamber part 2 is some text that varies. The chamber part 2 is "[if c_1 is open and the c_1 contains nothing] The safe is empty, what a horrible day![end if]".
...
The description of c_0 is "The type T box looks strong, and impossible to break. [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
The printed name of c_0 is "type T box".
Understand "type T box" as c_0.
...
The description of k_0 is "The type T latchkey is cold to the touch".
...
Test quest0_0 with "go east / close type T box / lock type T box with type T latchkey"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is how to play! First of all, make an attempt to take a trip east. And then, close the type ".
The objective part 1 is some text that varies. The objective part 1 is "T box. And then, look and see the type T box is locked. Once that's all handled, you can stop!".
