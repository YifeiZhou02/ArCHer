...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "Well I'll be, you are in the place we're calling the kitchenette.
 ...
 You can see a type 9 box.[if c_0 is open and there is something in the c_0] The type 9 box contains [a list of things in the c_0].[end if]".
The kitchenette part 1 is some text that varies. The kitchenette part 1 is "[if c_0 is open and the c_0 contains nothing] The type 9 box is empty, what a horrible day![end if]".
...
The recreation zone part 1 is some text that varies. The recreation zone part 1 is "[if there is nothing on the s_0]But oh no! there's nothing on this piece of trash. What, you think everything in TextWorld should have stuff on it?[end if]".
...
The description of c_0 is "The type 9 box looks strong, and impossible to destroy. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
Test quest0_0 with "go north / go east / open type 9 box"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is your task for today. First thing I need you to do is to go north. And then, attempt to head east. After ".
The objective part 1 is some text that varies. The objective part 1 is "that, make absolutely sure that the type 9 box in the kitchenette is wide open. And if you do that, you're the winner!".
