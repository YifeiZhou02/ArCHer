...
The cookhouse part 2 is some text that varies. The cookhouse part 2 is " You can see a freezer.[if c_1 is open and there is something in the c_1] The freezer contains [a list of things in the c_1].[end if]".
The cookhouse part 3 is some text that varies. The cookhouse part 3 is "[if c_1 is open and the c_1 contains nothing] The freezer is empty, what a horrible day![end if]".
...
The f_2 is in r_0.
The f_2 is edible.
The description of f_0 is "The grape looks tantalizing.".
...
Test quest0_0 with "go north / go east / close chest"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, make an attempt to move north. Once you finish that, attempt to go to the east. And then, ".
The objective part 1 is some text that varies. The objective part 1 is "make it so that the chest within the cookhouse is closed. That's it!".
