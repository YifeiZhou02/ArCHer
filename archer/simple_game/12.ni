...
The vault part 0 is some text that varies. The vault part 0 is "You find yourself in a vault. A standard one. You begin looking for stuff.
 ...
 You can see a rack. [if there is something on the s_0]On the rack you see [a list of things on the s_0].[end if]".
...
The s_0 is in r_2.
The description of o_0 is "The pair of pants is unremarkable.".
...
Test quest0_0 with "go north / go east / take pair of pants from rack"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, you could, like, go north. After that, venture east. Okay, and then, retrieve the pair of ".
The objective part 1 is some text that varies. The objective part 1 is "pants from the rack. And if you do that, you're the winner!".
