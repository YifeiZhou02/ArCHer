...
The launderette part 0 is some text that varies. The launderette part 0 is "You are in a launderette.
 ...
 What's that over there? It looks like it's a drawer.[if c_1 is open and there is something in the c_1] The drawer contains [a list of things in the c_1].[end if]".
...
Test quest0_0 with "take latchkey from drawer / go east / unlock chest with latchkey"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First stop, pick up the latchkey from the drawer within the launderette. Then, head east. Once you accom".
The objective part 1 is some text that varies. The objective part 1 is "plish that, make sure that the chest is unlocked. And once you've done that, you win!".
