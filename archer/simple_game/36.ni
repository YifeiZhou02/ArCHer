...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You find yourself in a kitchen. An usual kind of place.
 ...
 You can make out a shelf. The shelf is usual.[if there is something on the s_0] On the shelf you can make out [a list of things on the s_0]. You can't wait to tell the folks at home about this![end if]".
...
Test quest0_0 with "go east / take spork from saucepan / put spork on shelf"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another life changing episode of TextWorld! Here is how to play! First thing I need you to do is to take a trip east. Next, take the spork from the saucepan within the kitchen. With the spo".
The objective part 1 is some text that varies. The objective part 1 is "rk, rest the spork on the shelf. And if you do that, you're the winner!".
