...
The studio part 0 is some text that varies. The studio part 0 is "You are in a studio. An ordinary one.
 ...
 Were you looking for a display? Because look over there, it's a display.[if c_0 is open and there is something in the c_0] The display contains [a list of things in the c_0]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
...
The chamber part 0 is some text that varies. The chamber part 0 is "Ah, the chamber. This is some kind of chamber, really great usual vibes in this place, a wonderful usual atmosphere. And now, well, you're in it. The room is well lit.

 Oh wow! Is that what I think it is? It is! It's a bench. The bench is typical.[if there is something on the s_0] On the bench you make out [a list of things on the s_0].[end if]".
...
The description of o_0 is "The napkin appears to be out of place here".
...
Test quest0_0 with "go east / open display / insert napkin into display"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another exciting round of TextWorld! First step, go to the east. Following that, ensure that the display is open. And then, deposit the napkin into the display inside the studio. That's it!".
