...
The sauna part 0 is some text that varies. The sauna part 0 is "You arrive in a sauna. An ordinary one.
 ...
 You make out a locker.[if c_0 is open and there is something in the c_0] The locker contains [a list of things in the c_0]. Now why would someone leave that there?[end if]".
...
Test quest0_0 with "take vacuum from locker / go south / drop vacuum"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Your first objective is to take the vacuum from the locker. Then, go to the south. That done, drop the vacuum on the floor of the attic. Got that? ".
