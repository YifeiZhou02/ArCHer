...
The basement part 1 is some text that varies. The basement part 1 is " box right there by you.[if c_0 is open and there is something in the c_0] The box contains [a list of things in the c_0].[end if]".
...
The basement part 3 is some text that varies. The basement part 3 is " You see a shelf. What a coincidence, weren't you just thinking about a shelf? The shelf is usual.[if there is something on the s_0] On the shelf you make out [a list of things on the s_0].[end if]".
The basement part 4 is some text that varies. The basement part 4 is "[if there is nothing on the s_0] But there isn't a thing on it. You make a mental note to not get your hopes up the next time you see a shelf in a room.[end if]".
...
The spare room part 0 is some text that varies. The spare room part 0 is "I am pleased to announce that you are now in the spare room.
 ...
 You make out a cabinet. Make a note of this, you might have to put stuff on or in it later on.[if c_1 is open and there is something in the c_1] The cabinet contains [a list of things in the c_1].[end if]".
...
Test quest0_0 with "go east / take keycard from shelf / unlock box with keycard"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First of all, you could, like, head east. Following that, pick up the keycard from the shelf within the basement. And then, unlock the box inside the".
The objective part 1 is some text that varies. The objective part 1 is " basement. Got that? Good!".
