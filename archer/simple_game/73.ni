...
The cubicle part 0 is some text that varies. The cubicle part 0 is "Look around you. Take it all in. It's not every day someone gets to be in a cubicle.
 ...
 You make out a coffer.[if c_0 is open and there is something in the c_0] The coffer contains [a list of things in the c_0]. There's something strange about this being here, but you can't put your finger on it.[end if]".
The cubicle part 1 is some text that varies. The cubicle part 1 is "[if c_0 is open and the c_0 contains nothing] The coffer is empty! This is the worst thing that could possibly happen, ever![end if]".
The cubicle part 2 is some text that varies. The cubicle part 2 is " You make out a stand. The stand is standard.[if there is something on the s_0] On the stand you see [a list of things on the s_0].[end if]".
...
Test quest0_0 with "go east / take mouse from stand / insert mouse into coffer"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is how to play! First stop, move east. If you can accomplish that, take the mouse from the s".
The objective part 1 is some text that varies. The objective part 1 is "tand. And then, insert the mouse into the coffer in the cubicle. And if you do that, you're the winner!".
