...
The scullery part 1 is some text that varies. The scullery part 1 is " locker is right there by you.[if c_0 is open and there is something in the c_0] The locker contains [a list of things in the c_0].[end if]".
...
The cellar part 0 is some text that varies. The cellar part 0 is "You arrive in a cellar. A normal kind of place. You begin looking for stuff.
 ...
 Look out! It's a- oh, never mind, it's just a suitcase.[if c_1 is open and there is something in the c_1] The suitcase contains [a list of things in the c_1].[end if]".
...
Test quest0_0 with "go south / open locker / take coffee cup from locker"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a exciting episode of TextWorld! Here is your task for today. First off, if it's not too much trouble, I need you to venture south. With that over with, ensure that the locker with".
The objective part 1 is some text that varies. The objective part 1 is "in the scullery is open. And then, retrieve the coffee cup from the locker in the scullery. Alright, thanks!".
