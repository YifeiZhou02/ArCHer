...
The laundry place part 1 is some text that varies. The laundry place part 1 is "[if c_0 is open and the c_0 contains nothing] The basket is empty! What a waste of a day![end if]".
...
The cellar part 1 is some text that varies. The cellar part 1 is " crate.[if c_1 is open and there is something in the c_1] The crate contains [a list of things in the c_1].[end if]".
The cellar part 2 is some text that varies. The cellar part 2 is "[if c_1 is open and the c_1 contains nothing] The crate is empty, what a horrible day![end if]".
...
Test quest0_0 with "take worm from crate / go south / insert worm into basket"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is how to play! First, it would be good if you could recover the worm from the crate in the cellar. And then, go south. Then, you can deposit ".
The objective part 1 is some text that varies. The objective part 1 is "the worm into the basket within the laundry place. Alright, thanks!".
