...
Test quest0_0 with "go east / take mop from shelf / drop mop"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Your first objective is to head east. And then, retrieve the mop from the shelf. With the mop, toss the mop on t".
The objective part 1 is some text that varies. The objective part 1 is "he floor of the shower. Once that's all handled, you can stop!".
