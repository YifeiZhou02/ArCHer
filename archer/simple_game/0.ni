...
The cellar part 1 is some text that varies. The cellar part 1 is " Henderson's style safe.[if c_0 is open and there is something in the c_0] The Henderson's style safe contains [a list of things in the c_0]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
The cellar part 2 is some text that varies. The cellar part 2 is "[if c_0 is open and the c_0 contains nothing] The Henderson's style safe is empty! What a waste of a day![end if]".
...
Test quest0_0 with "open Henderson's style safe / take broom from Henderson's style safe / drop broom"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a exciting game of TextWorld! Your first objective is to ensure that the Henderson's style safe is open. After that, recover the broom from the Henderson's style safe. Then, throw ".
The objective part 1 is some text that varies. The objective part 1 is "the broom on the floor of the cellar. And if you do that, you're the winner!".
