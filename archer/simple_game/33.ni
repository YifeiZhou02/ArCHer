...
The cubicle part 1 is some text that varies. The cubicle part 1 is " safe in the room.[if c_0 is open and there is something in the c_0] The safe contains [a list of things in the c_0].[end if]".
...
The description of o_0 is "The keyboard appears well matched to everything else here".
The printed name of o_0 is "keyboard".
Understand "keyboard" as o_0.
The o_0 is in the c_0.
The description of o_1 is "The folder is brand new.".
...
Test quest0_0 with "open safe / take keyboard from safe / drop keyboard"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! First of all, you could, like, ensure that the safe is open. After that, take the keyboard from the safe inside the cubicle. If you can get your hands on the keyboard, toss the k".
The objective part 1 is some text that varies. The objective part 1 is "eyboard on the floor of the cubicle. That's it!".
