...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You are in a cubicle. A standard one.
 ...
 You see a type 6 chest. Classic TextWorld.[if c_0 is open and there is something in the c_0] The type 6 chest contains [a list of things in the c_0].[end if]".
...
The washroom part 0 is some text that varies. The washroom part 0 is "You find yourself in a washroom. An ordinary kind of place.
 ...
 You can see a rack. You shudder, but continue examining the rack. The rack is usual.[if there is something on the s_0] On the rack you see [a list of things on the s_0].[end if]".
The washroom part 1 is some text that varies. The washroom part 1 is "[if there is nothing on the s_0] But oh no! there's nothing on this piece of junk. Aw, here you were, all excited for there to be things on it![end if]".
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "A well framed board tells you that you are now in the cookhouse. Okay, just remember what you're here to do, and everything will go great.
...
The c_0 is in r_1.
The c_0 is closed.
The description of k_0 is "The type 6 latchkey is surprisingly heavy.".
...
Test quest0_0 with "go south / open type 6 chest / insert teaspoon into type 6 chest"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First, it would be great if you could travel south. And then, ensure that the type 6 chest is open. Then".
The objective part 1 is some text that varies. The objective part 1 is ", you can deposit the teaspoon into the type 6 chest inside the cubicle. Got that? Good!".
