...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You find yourself in a bedroom. A standard one. You decide to just list off a complete list of everything you see in the room, because hey, why not?
 ...
 You can see a type X box.[if c_0 is open and there is something in the c_0] The type X box contains [a list of things in the c_0]. Now that's what I call TextWorld![end if]".
The bedroom part 1 is some text that varies. The bedroom part 1 is "[if c_0 is open and the c_0 contains nothing] The type X box is empty! What a waste of a day![end if]".
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "You've entered a kitchenette.
 ...
 You make out a platter. The platter is standard.[if there is something on the s_0] On the platter you can make out [a list of things on the s_0].[end if]".
The kitchenette part 1 is some text that varies. The kitchenette part 1 is "[if there is nothing on the s_0] However, the platter, like an empty platter, has nothing on it. Aw, and here you were, all excited for there to be things on it![end if]".
...
The description of c_0 is "The type X box looks strong, and impossible to break. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The description of o_1 is "The nest of puppies is dirty.".
...
Test quest0_0 with "go east / take type X latchkey / unlock type X box with type X latchkey"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! First step, take a trip east. That done, retrieve the type X latchkey from the floor of the bedroom. Then, doublecheck that the type X box is unloc".
The objective part 1 is some text that varies. The objective part 1 is "ked. And if you do that, you're the winner!".
