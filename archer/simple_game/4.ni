...
The cookery part 0 is some text that varies. The cookery part 0 is "You are in a cookery. A standard kind of place.
 ...
 You can make out a freezer. I mean, just wow! Isn't TextWorld just the best?[if c_0 is open and there is something in the c_0] The freezer contains [a list of things in the c_0].[end if]".
...
Test quest0_0 with "take carrot / go east / eat carrot"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! First off, pick up the carrot from the floor of the shower. After that, eat the carrot. Got that? Good!".
