...
The dish-pit part 1 is some text that varies. The dish-pit part 1 is " safe is close by.[if c_0 is open and there is something in the c_0] The safe contains [a list of things in the c_0]. You can't wait to tell the folks at home about this![end if]".
The dish-pit part 2 is some text that varies. The dish-pit part 2 is "[if c_0 is open and the c_0 contains nothing] The safe is empty! What a waste of a day![end if]".
The dish-pit part 3 is some text that varies. The dish-pit part 3 is " You make out a pan. [if there is something on the s_0]You see [a list of things on the s_0] on the pan.[end if]".
...
The restroom part 0 is some text that varies. The restroom part 0 is "You arrive in a restroom. A normal kind of place.
 ...
 You see a bench. [if there is something on the s_1]On the bench you can see [a list of things on the s_1].[end if]".
...
Test quest0_0 with "go east / take latchkey from pan / lock safe with latchkey"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a fast paced episode of TextWorld! Here is your task for today. First off, if it's not too much trouble, I need you to make an effort to go to the east. And then, pick up the latch".
The objective part 1 is some text that varies. The objective part 1 is "key from the pan. After that, doublecheck that the safe in the dish-pit is locked with the latchkey. And if you do that, you're the winner!".
