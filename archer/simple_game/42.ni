...
The restroom part 0 is some text that varies. The restroom part 0 is "You are in a restroom. It seems to be pretty typical here.
 ...
 You can see a dresser. Hmm. You always thought you'd be more excited to see a dresser in a room.[if c_0 is open and there is something in the c_0] The dresser contains [a list of things in the c_0].[end if]".
...
The restroom part 2 is some text that varies. The restroom part 2 is " You can make out a counter. The counter is typical.[if there is something on the s_0] On the counter you can make out [a list of things on the s_0]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
The restroom part 3 is some text that varies. The restroom part 3 is "[if there is nothing on the s_0] The counter appears to be empty. Hm. Oh well[end if]".
...
The attic part 0 is some text that varies. The attic part 0 is "You make another one of your grand eccentric entrances into an attic. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
Test quest0_0 with "go east / take mop from counter / insert mop into dresser"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is your task for today. First stop, make an effort to go east. Then, pick up the mop from th".
The objective part 1 is some text that varies. The objective part 1 is "e counter in the restroom. Then, you can place the mop into the dresser in the restroom. And once you've done that, you win!".
