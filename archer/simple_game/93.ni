...
The scullery part 0 is some text that varies. The scullery part 0 is "You arrive in a scullery. A standard one. You try to gain information on your surroundings by using a technique you call 'looking.'

 You hear a noise behind you and spin around, but you can't see anything other than a chest. Hmmm... what else, what else?[if c_0 is open and there is something in the c_0] The chest contains [a list of things in the c_0]. Hmmm... what else, what else?[end if]".
...
The scullery part 2 is some text that varies. The scullery part 2 is " You see a case.[if c_1 is open and there is something in the c_1] The case contains [a list of things in the c_1]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
The scullery part 3 is some text that varies. The scullery part 3 is "[if c_1 is open and the c_1 contains nothing] The case is empty! This is the worst thing that could possibly happen, ever![end if]".
...
Test quest0_0 with "go south / take key / lock chest with key"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! First of all, make an attempt to go south. Then, retrieve the key from the floor of the scullery. If you can get".
The objective part 1 is some text that varies. The objective part 1 is " your hands on the key, Place the key into the chest to lock it. And if you do that, you're the winner!".
