...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "You've seen better cookhouses, but at least this one seems pretty usual. Okay, just remember what you're here to do, and everything will go great.
...
Test quest0_0 with "unlock chest with passkey / open chest / take coffee cup from chest"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a exciting session of TextWorld! Here is how to play! First step, unlock the chest with the passkey. If you have unlocked the chest, look and see that the chest is opened. Then, pi".
The objective part 1 is some text that varies. The objective part 1 is "ck up the coffee cup from the chest within the cookhouse. That's it!".
