...
The study part 2 is some text that varies. The study part 2 is " Were you looking for a box? Because look over there, it's a box. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[if c_1 is open and there is something in the c_1] The box contains [a list of things in the c_1].[end if]".
...
Test quest0_0 with "open box / take latchkey from box / unlock safe with latchkey"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is your task for today. First, it would be a great idea if you could ensure that the box inside the study i".
The objective part 1 is some text that varies. The objective part 1 is "s open. After that, take the latchkey from the box within the study. Then, unlock the safe. Alright, thanks!".
