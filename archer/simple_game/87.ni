...
The steam room part 1 is some text that varies. The steam room part 1 is " chest.[if c_0 is open and there is something in the c_0] The chest contains [a list of things in the c_0].[end if]".
...
Test quest0_0 with "go south / go east / close chest"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an fast paced round of TextWorld? You do! Here is how to play! First of all, venture south. Next, go east. After that, make sure that the chest".
The objective part 1 is some text that varies. The objective part 1 is " is closed. Once that's all handled, you can stop!".
