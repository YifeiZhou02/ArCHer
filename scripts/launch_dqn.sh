...
# accelerate launch --main_process_port 48790 run_filteredbc.py --config-name filteredbc_20q
accelerate launch --main_process_port 13897 run_dqn.py --config-name dqn_detective
